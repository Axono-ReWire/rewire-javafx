        ...
        return new YearGroup[] {
                ...
                new YearGroup("Foundation Year",
                        new Section(CORE_MODULES,
                                new Module("Mathematics 1", "Algebra, calculus, and mathematical reasoning"),
                                new Module("Physics 1", "Mechanics, waves, and thermodynamics basics"),
                                new Module("Skills for Engineering and the Physical Sciences 1",
                                        "Lab skills, academic writing, and scientific methods"),
                                new Module("Mathematics 2", "Trigonometry, vectors, and differential equations"),
                                new Module("Physics 2", "Electromagnetism, optics, and quantum fundamentals"),
                ...
                new YearGroup("Year 1",
                        new Section(CORE_MODULES,
                                ...
                                new Module("Mathematics", "Calculus, linear algebra, and complex numbers"),
                                new Module("Analogue Electronics", "Op-amps, filters, and circuit analysis")),
                        new Section("Option Modules",
                                new Module("Digital Electronics",
                                        "Logic gates, flip-flops, and digital circuit design"),
                                new Module("Materials and Mechanics", "Stress, strain, and material properties"))),
                ...
                new YearGroup("Year 2",
                        ...
                        new Section("Option Modules",
                                ...
                                new Module("Circuit Design", "PCB layout, simulation, and mixed-signal design"),
                                new Module("Electromagnetism", "Maxwell's equations, wave propagation, and antennas"),
                                new Module("Software Design", "OOP, design patterns, and software architecture"),
                ...
                new YearGroup("Year 3",
                        new Section(null,
                                ...
                                new Module("Multimedia Sound Design", "Synthesis, sound design, and spatial audio"),
                                new Module("Principles of Microengineering",
                                        "MEMS, microfabrication, and miniaturised systems"),
                                new Module("Applications of Electromagnetics", "Antenna design, RF systems, and EMC"),
                                ...
                                new Module("Renewable Power Generation", "Wind, hydro, and grid integration"),
                                ...
                                new Module("Digital Engineering", "HDL, FPGAs, and digital system design"),
                                ...
                                new Module("Astrobiology", "Origin of life, extremophiles, and planetary habitability"),
                ...
                new YearGroup("Year 4",
                        new Section(null,
                                ...
                                new Module("Systems Programming for ARM", "Embedded C, memory-mapped I/O, and RTOS"),
                                new Module("Machine Learning and Computational Intelligence",
                                        "Neural networks, SVMs, and deep learning"),
                                new Module("Power Electronics", "Converters, inverters, and switching circuits"),
                                ...
                                new Module("Advanced Control", "State-space, robust, and optimal control systems"),
                                new Module("Smart Grid", "Grid topology, demand response, and smart metering"),
